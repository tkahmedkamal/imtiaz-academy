...
import useArchivedStudents from '../../useArchivedStudents';
import StudentsEnrollmentRow from './ArchivedStudentsEnrRow';
import { useStudentsCtx } from '../../../../context/StudentContext';

const ArchivedStudentsEnrTable = () => {
  const { t } = useTranslation();
  const { data, isLoading } = useArchivedStudents();
...
export default ArchivedStudentsEnrTable;
